...
public abstract class AssignmentDatabase extends RoomDatabase {
            ...
            synchronized (AssignmentDatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            AssignmentDatabase.class, "assignment_database")
    ...
    private static Callback sRoomDatabaseCallback = new Callback(){
        ...
        public void onOpen (@NonNull SupportSQLiteDatabase db){
            ...
            // comment out the following line. Tag: Assignment memory words
//            new PopulateDbAsync(INSTANCE).execute();
    ...
    private static class PopulateDbAsync extends AsyncTask<Void, Void, Void> {
        ...
        private final AssignmentDao mDao;

        PopulateDbAsync(AssignmentDatabase db) {
            mDao = db.assignmentDao();
        }
        ...
        protected Void doInBackground(final Void... params) {
            ...
            Assignment assignment = new Assignment(0, "Assignment", 6, 6, 6, "AP", "oof" );
            mDao.insert(assignment);
            assignment = new Assignment(0, "Page", 5, 5, 5, "IB", "oof" );
            mDao.insert(assignment);
            return null;
        }
    }
